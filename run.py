...
def validate_data(values):
    ...
    try:
        ...
        if len(values) != 6:
            raise ValueError(
                f'Exacly 6 values required, you provide {len(values)}'
            )
...
def update_worksheet(data, worksheet):
    ...
    Update the relavant worksheet with the data provide
    """
...
def calculate_surplus_data(sales_row):
    ...
    - Positve surplus indicate waste
...
def get_last_5_entries_sales():
    ...
    the last 5 entries for each sandwich and returns the data as a list of list
    """
